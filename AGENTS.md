# AI Agent Instructions — stable-audio-tools
...
**Direct tool call:** `get_tool("stable-audio-tools-v1")`
**REST fallback:** GET https://aiaam.xyz/api/v1/tools/stable-audio-tools-v1
