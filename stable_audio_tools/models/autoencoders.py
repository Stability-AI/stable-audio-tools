...
class DACEncoderWrapper(nn.Module):
    def __init__(self, in_channels=1, **kwargs):
        ...
        self.proj_out = (
            nn.Conv1d(self.encoder.enc_dim, latent_dim, kernel_size=1) if latent_dim is not None else nn.Identity()
        )
...
class DiffusionAutoencoder(AudioAutoencoder):
    def __init__(self, diffusion: ConditionedDiffusionModel, diffusion_downsampling_ratio, *args, **kwargs):
