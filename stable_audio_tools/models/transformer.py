...
class Attention(nn.Module):
    ...
    def forward(self, x, context=None, mask=None, context_mask=None, rotary_pos_emb=None, causal=None):
...
class TransformerBlock(nn.Module):
    def __init__(
        ...
        self.self_attn = Attention(
            dim, dim_heads=dim_heads, causal=causal, zero_init_output=zero_init_branch_outputs, **attn_kwargs
        )
...
class ContinuousTransformer(nn.Module):
    ...
    def forward(
        self, x, mask=None, prepend_embeds=None, prepend_mask=None, global_cond=None, return_info=False, **kwargs
    ):
        ...
        if prepend_embeds is not None:
            ...
            if prepend_mask is not None or mask is not None:
                ...
                prepend_mask = (
                    ...
                    else torch.ones((batch, prepend_length), device=device, dtype=torch.bool)
                )
